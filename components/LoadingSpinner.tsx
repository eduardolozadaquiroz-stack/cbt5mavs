...
interface LoadingSpinnerProps {
  duration?: number; // milliseconds before it disappears (default 3000ms)
}
...
export default function LoadingSpinner({ duration = 3000 }: LoadingSpinnerProps) {
  ...
  return (
    <div className="fixed inset-0 z-[9999] flex items-center justify-center bg-[#f8f8f8] dark:bg-slate-950 backdrop-blur-sm">
      {/* Spinner container */}
